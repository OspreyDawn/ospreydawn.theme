...
CHAKRA.slider = function(){
	$.supersized({
		...
		slides 					:  	[			// Slideshow Images
											{image : 'assets/osprey/img/slider-images/image01.jpg', title : '<div class="slide-content"></div>', thumb : '', url : ''},
											{image : 'assets/osprey/img/slider-images/image02.jpg', title : '<div class="slide-content"></div>', thumb : '', url : ''},
											{image : 'assets/osprey/img/slider-images/image03.jpg', title : '<div class="slide-content"></div>', thumb : '', url : ''},
											{image : 'assets/osprey/img/slider-images/image04.jpg', title : '<div class="slide-content"></div>', thumb : '', url : ''}  
									],
...
CHAKRA.contactForm = function(){
	$("#contact-submit").on('click',function() {
		...
		$.ajax({
			type: "POST",
			url: "assets/osprey/php/contact.php",
			data: fields,
			dataType: 'json',
...
CHAKRA.map = function(){
	if($('.map').length > 0)
	{
		...
		$('.map').each(function(i,e){
			...
			var image = 'assets/osprey/img/marker.png';
